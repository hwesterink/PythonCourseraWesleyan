# -phones_reorder.py *- coding: utf-8 -*-
"""
This program maintains a database of names and phone numbers in a csv
file called myphones.csv. This version was adapted for problem4_4: a new
function reorder was added.
It is run from the command line and is menu driven. To start it, save it
in a directory and from the terminal run
>python phones_reorder.py

Version FINAL: Reorder function added for problem4_4.
"""
...
# Define helper functions for this program
...
# Define functions that execute the menu options    
def create_phone():
...
# Define functions that load and save the phone list
def load_phone_list():
...
# Define the function that displays the menu and receives the choice  
def menu_choice():
...
# Define the function with the main loop for the program
def main_loop():
