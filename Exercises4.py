...
def make_random_real():
    """ Make a list of 10 random real numbers """
    reallis = []
    for i in range(0,10):
...
#%%
def make_random_real():
    """ Make a list of 10 random real numbers that are the same each run """
    random.seed(17)
    reallis = []
    for i in range(0,10):
        reallis.append(random.random())
...
print("Start||{0:>25}||End - minimum width 25, right aligned".format(s))
print("Start||{0:<25}||End - minimum width 25, left aligned".format(s))
print("Start||{0:^25}||End - minimum width 25, centered".format(s))
